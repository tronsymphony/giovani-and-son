            ...
            if( ( current_user_can( 'administrator' ) || current_user_can( 'shop_manager' ) ) && get_option( 'wwp_admin_notice_getting_started_show' ) === 'yes' ) { 
                ...
                if( $screen->id === 'settings_page_wwc_license_settings' || $screen->post_type === 'product' || in_array( $screen->parent_base , array( 'woocommerce' , 'plugins' ) ) ) { ?>
                    ...
                    <div class="updated notice wwp-getting-started">
                        ...
                        <p><a href="https://wholesalesuiteplugin.com/kb/woocommerce-wholesale-prices-free-plugin-getting-started-guide/?utm_source=freeplugin&utm_medium=kb&utm_campaign=wwpgettingstarted" target="_blank">
                        ...
                        <button type="button" class="notice-dismiss"><span class="screen-reader-text"><?php _e( 'Dismiss this notice.' , 'woocommerce-wholesale-prices' ); ?></span></button>
                    </div><?php
