...
<tr valign="top">
    <th scope="row" class="titledesc"><?php _e( 'Default discount name', 'advanced-dynamic-pricing-for-woocommerce' ) ?></th>
    <td class="forminp forminp-checkbox">
        <fieldset>
            ...
            <div>
				<?php _e( 'Fixed discounts with the same name are grouped in the cart.', 'advanced-dynamic-pricing-for-woocommerce' ) ?>
            </div>
        </fieldset>
    </td>
</tr>
