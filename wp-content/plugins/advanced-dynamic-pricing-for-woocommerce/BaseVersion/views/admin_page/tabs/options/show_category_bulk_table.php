...
<tr valign="top">
	<th scope="row" class="titledesc"><?php _e('Show bulk table on category page', 'advanced-dynamic-pricing-for-woocommerce') ?></th>
	<td class="forminp forminp-checkbox">
		<fieldset>
			<legend class="screen-reader-text"><span><?php _e('Show bulk table on category page', 'advanced-dynamic-pricing-for-woocommerce') ?></span></legend>
